...
Inst_FM_snare_1:
    ;       op1   op2   op3   op4 
    dc.b    0x00, 0x00, 0x03, 0x01, &   ;det_mul
            0x00, 0x00, 0x0D, 0x03, &   ;tl
            0x18, 0x1F, 0x1F, 0x1D, &   ;rs_ar
            0x05, 0x00, 0x18, 0x13, &   ;am_d1r
            0x1F, 0x1C, 0x11, 0x15, &   ;d2r
            0xF3, 0x00, 0x09, 0xF8, &   ;sl_rr
            0x3C, &                     ;fb_alg
            0xC0                        ;lr_amfm
    
Inst_agr_bass_1:
    ;       op1   op2   op3   op4 
    dc.b    0x07, 0x00, 0x00, 0x00, &   ;det_mul
            0x16, 0x1B, 0x13, 0x11, &   ;tl
            0x1F, 0x1F, 0x1F, 0x1F, &   ;rs_ar
            0x13, 0x0E, 0x0A, 0x1F, &   ;am_d1r
            0x00, 0x00, 0x00, 0x00, &   ;d2r
            0x5F, 0xAF, 0x5F, 0x0F, &   ;sl_rr
            0x01, &                     ;fb_alg
            0xC0                        ;lr_amfm

Inst_agr_horn_1:
    ;       op1   op2   op3   op4 
    dc.b    0x01, 0x01, 0x07, 0x01, &   ;det_mul
            0x18, 0x27, 0x28, 0x0D, &   ;tl
            0x8E, 0x8D, 0x8E, 0x9F, &   ;rs_ar
            0x0E, 0x0E, 0x0E, 0x03, &   ;am_d1r
            0x00, 0x01, 0x01, 0x01, &   ;d2r
            0x14, 0x14, 0xF8, 0x05, &   ;sl_rr
            0x3A, &                     ;fb_alg
            0xC0                        ;lr_amfm
            
Inst_agr_horn_2:
    ;       op1   op2   op3   op4 
    dc.b    0x51, 0x63, 0x52, 0x01, &   ;det_mul
            0x0E, 0x18, 0x16, 0x16, &   ;tl
            0x1F, 0x1A, 0x13, 0x1B, &   ;rs_ar
            0x0B, 0x04, 0x05, 0x1F, &   ;am_d1r
            0x01, 0x01, 0x01, 0x01, &   ;d2r
            0x33, 0x33, 0x33, 0x08, &   ;sl_rr
            0x2D, &                     ;fb_alg
            0xC0                        ;lr_amfm
...
inst_psg_plink:
        ;   A      ML    D      S     R    NM
    dc.b    0x0C, 0x0C, 0x01, 0x00, 0x01, 0x00 
    dc.b    0x00,       0x00,       0x00
Inst_psg_pad:
        ;   A      ML    D      S     R    NM
    dc.b    0x03, 0x0C, 0x01, 0x08, 0x01, 0x00 
    dc.b    0x00,       0x00,       0x01
    
Inst_psg_soft:
        ;   A      ML    D      S     R    NM
    dc.b    0x01, 0x0C, 0x01, 0x05, 0x01, 0x00 
    dc.b    0x01,       0x00,       0x00
